                ...
                <aside class="jm-home-jobs-sidebar">
                    ...
                    <div style="display:grid;gap:10px;margin-bottom:18px;">
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;font-size:14px;">
                            ...
                            <strong><?= jm_price(PRICE_EMPLOYER_BASIC_MONTHLY, '/mo', USD_PRICE_EMPLOYER_BASIC_MONTHLY) ?></strong>
                        </div>
                        <div style="display:flex;align-items:center;justify-content:space-between;font-size:14px;">
                            <span style="color:var(--jm-muted);">Pro plan</span>
                            <strong><?= jm_price(PRICE_EMPLOYER_PRO_MONTHLY, '/mo', USD_PRICE_EMPLOYER_PRO_MONTHLY) ?></strong>
                        </div>
                    </div>
        ...
        <section class="jm-hp-section">
            <div class="jm-premium-strip">
                ...
                <div>
                    ...
                    <span class="jm-premium-strip-price">From <?= jm_price(PRICE_SEEKER_PREMIUM_MONTHLY, '/month', USD_PRICE_SEEKER_PREMIUM_MONTHLY) ?> · Credits from <?= jm_price(PRICE_CREDITS_SINGLE, '', USD_PRICE_CREDITS_SINGLE) ?></span>
                </div>
